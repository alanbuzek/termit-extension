const cs = {
  ...
  "asset.create.iri.help":
    "Identifikátor záznamu ve formě Internationalized Resource Identifier (IRI). Identifikátor bude vygenerován automaticky na základě názvu. Můžete ho však též zadat ručně.",
  "asset.label": "Název",
  ...
  "vocabulary.summary.import.dialog.message":
    "Nahrajte dříve vyexportovanou verzi tohoto slovníku (ve formátu SKOS a obsahující jedinou skos:ConceptScheme ve tvaru <IRI-TOHOTO-SLOVNÍKU>/glosář).",
  ...
  "vocabulary.import.dialog.message":
    "Importovaný soubor musí být formátu SKOS. Soubor musí obsahovat jediný skos:ConceptScheme.",
  ...
  "term.metadata.altLabels.help":
    "(Nepovinná) synonyma k názvu. Synonyma mohou být kontextuální - např. pojem s názvem 'Adresa organizace' může mít synonymum 'Adresa', které se však použije jen v určitém kontextu (např. ve formuláři, ve kterém se vyplňují informace o organizaci). ",
  ...
  "term.metadata.hiddenLabels.help":
    "(Nepovinné) vyhledávací texty, nejsou určeny pro vizuální prezentaci pojmu a slouží zejména pro vyhledávání. Nemusí se jednat (ani kontextuální) synonyma k názvu pojmu. Např. pojem s názvem 'Kopaná' může mít vyhledávací text 'fočus'. ",
  ...
  "term.metadata.related.help":
    "(Nepovinný) související pojem (bez bližšího určení o jakou souvislost se jedná). Může se jednat o pojem z aktuálního slovníku nebo z jiného slovníku. Např. pojem 'vozidlo' souvisí s pojmem 'řidič'. Nevybírejte pojem, který už je označen jako 'nadřazený pojem', nebo 'pojem se stejným významem'.",
