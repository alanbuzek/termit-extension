...
/**
 * This defines only context part specific to Website. Complete context can be obtained from Document context.
 *
...
export default class Website extends Resource implements WebsiteData {
  ...
  public toJsonLd(): {} {
    const jsonLd: any = {
      ...this, // Import lazily to evade circular dependency in context definition between Website and Document
