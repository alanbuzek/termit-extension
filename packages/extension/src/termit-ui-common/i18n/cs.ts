...
const cs = {
  ...
  messages: {
    ...
    'extension.annotated.with': 'Stránka je anotována s: ',
    'extension.annotated.notfound': 'anotací nebylo nalezeno',
    'extension.notfound.annotations': 'Nenelezené anotace:',
    'extension.found.annotations': 'nalezené anotace',
    'extension.page.annotations': 'Anotace na stránce:',
    'extension.annotation.label': 'Pojem',
    'extension.annotation.definition': 'Definice',
    'extension.assigned.term': 'Přiřazený pojem',
    'extension.assigned.definition': 'Přiřazená definice',
    'extension.assign.prompt': 'Přiřadit pojem',
    'extension.definition.prompt': 'Přiřadit definici k pojmu',
    'terms.select.assignment.placeholder': 'Vyberte pojem k přiřazení',
    'occurrence.unknown.term': 'Neznámý pojem',
    'occurrence.existing.term': 'Existující pojem',
    'occurrence.known.definition': 'Definice pojmu',
    'occurrence.unknown.definition': 'Neznámá definice',
    'occurrence.suggested.new.term': 'Navržený nový pojem',
    'occurrence.suggested.existing.term': 'Navržený existující pojem',
    'extension.occurrences.filter.placeholder': 'Filtrovat textem',
    'extension.occurrences.all': 'Všechny výskytu',
