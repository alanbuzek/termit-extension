...
import { getLabel } from '../../../shared/api';
 ...
 */
class AssetLabel extends React.Component<AssetLabelProps, AssetLabelState> {
  ...
  private loadLabel(iri: string) {
    getLabel(iri).then((data: string) => this.setState({ label: data }));
  }
